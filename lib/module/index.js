...
export default class BottomSheetBehavior extends React.Component {
  ...
  render() {
    ...
    return /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement(Animated.View, {
    ...
    }, this.props.renderHeader && this.props.renderHeader())), /*#__PURE__*/React.createElement(View, {
      ...
      simultaneousHandlers: this.props.simultaneousHandlers
    }, /*#__PURE__*/React.createElement(Animated.View, null, /*#__PURE__*/React.createElement(TapGestureHandler, {
      ref: this.tapRef,
    ...
    }, this.props.renderContent && this.props.renderContent())))), /*#__PURE__*/React.createElement(Animated.Code, {
      exec: onChange(this.tapState, cond(eq(this.tapState, GestureState.BEGAN), stopClock(this.decayClock)))
    }), this.props.callbackNode && /*#__PURE__*/React.createElement(Animated.Code, {
    ...
    }), (this.props.onOpenStart || this.props.onCloseEnd) && /*#__PURE__*/React.createElement(Animated.Code, {
    ...
    }), (this.props.onOpenEnd || this.props.onCloseStart) && /*#__PURE__*/React.createElement(Animated.Code, {
    ...
    }), (this.props.onCloseStart || this.props.onOpenEnd) && /*#__PURE__*/React.createElement(Animated.Code, {
    ...
    }), (this.props.onCloseEnd || this.props.onOpenStart) && /*#__PURE__*/React.createElement(Animated.Code, {
    ...
    }), this.props.contentPosition && /*#__PURE__*/React.createElement(Animated.Code, {
      exec: onChange(this.Y, set(this.props.contentPosition, sub(0, this.Y)))
    }), this.props.headerPosition && /*#__PURE__*/React.createElement(Animated.Code, {
